...
namespace IIS.АСУ_Кондитерская
{
    ...
    public partial class ИндивидуальныйЗаказE : BaseEditForm<ИндивидуальныйЗаказ>
    {
        /// <summary>
        /// Конструктор формы.
        /// </summary>
        public ИндивидуальныйЗаказE()
            : base(ИндивидуальныйЗаказ.Views.ИндивидуальныйЗаказE)
        {
        }
        ...
        {
            get { return "~/forms/IndividualnyjZakaz/IndividualnyjZakazE.aspx"; }
        }
        ...
        protected override void PreApplyToControls()
        {
            ...
            if (Context.User.IsInRole("Продавец") && this.DataObject == null)
            {
                ...
                this.DataObject = new ИндивидуальныйЗаказ();
