...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="<%= Constants.FormControlsCssClass + " " + Constants.EditFormControlsCssClass %>">
            ...
            <div>
                ...
                <div class="clearfix">
                    ...
                    <ac:MasterEditorAjaxDropDown ID="ctrlИндивидуальныйЗаказ" CssClass="descTxt" runat="server" EnablePostBack="true"/>
    ...
    <script type="text/javascript">
        $(function () {
            $('#<%= ctrlПозицияВЧеке.ClientID %>').on('rowadded.ajaxgroupedit', function (e, d) {
                getSum();
                });
        });
        function getSum() {
            var data = $('#<%=ctrlПозицияВЧеке.ClientID%>').ajaxgroupedit('getDataRows');
            if (data.length != 0) {
                var result = '';
                $.each(data, function(index, value) {
                    result += value.innerHTML;
                });
                ctrlСумма.value = result;
            } else {
                ctrlСумма.value = 0;
            }
        };
